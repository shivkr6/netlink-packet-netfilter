...
use netlink_packet_core::{
    Emitable, NetlinkMessage, ParseableParametrized, NLM_F_DUMP, NLM_F_REQUEST,
};
...
use crate::{
    ...
    constants::{
        AF_INET, AF_INET6, AF_UNSPEC, IPCTNL_MSG_CT_GET, IPPROTO_TCP,
        IPPROTO_UDP,
    },
    NetfilterHeader, NetfilterMessage,
};

// sudo conntrack -D -p tcp -s 2409:40c4:356:9396:4d22:e710:1b57:5cc0 -d 2401:c080:2400:174d:5400:3ff:fef3:6dae --sport 36972 --dport 443
#[test]
fn testtemp() {
    let raw: Vec<u8> = vec![
        ,
    ];
...
fn test_get_conntrack_tcp_ipv4() {
    ...
    let proto_num = ProtoTuple::Protocol(IPPROTO_TCP);
...
fn test_get_conntrack_udp_ipv6() {
    ...
    let proto_num = ProtoTuple::Protocol(IPPROTO_UDP);
    ...
    let nlas = vec![ConntrackNla::CtaTupleOrig(vec![ip_tuple, proto_tuple])];
